...
\docsvlist{%
  ...
  For technical reason, if you want to use the \bibfield{bookineditor} with the \bibfield{bookinjournal} entry type, you must also use the \pkg{biblatex-morenames} package (see \reff{morenames}).
  }}},%
