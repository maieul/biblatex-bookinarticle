...
\docsvlist{%
  ...
  \unexpanded{\subsection{About \bibtype{bookinreference}}
...
\item Add \bibtype{bookincollection}, \bibtype{bookininproceedings}, \bibtype{bookinproceedings}, \bibtype{bookinreference} and related.
