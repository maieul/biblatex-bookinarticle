...
\docsvlist{%
  ...
  {{inbook}{Laudo}{We use the \emph{biblatex-anonymous} package to manage the anonymous entry here.}}
}
...
\begin{release}{2.2.0}{2016-09-08}
  ...
  \item Add \bibtype{bookininbook} and \bibtype{ininbook} entrytype.
\end{release}
